...
- [xgplayer](https://github.com/bytedance/xgplayer) - 西瓜播放器，带有解析器的HTML5视频播放器，可节省流量 ![](https://img.shields.io/github/stars/bytedance/xgplayer?style=social) ![](https://img.shields.io/github/last-commit/bytedance/xgplayer?style=flat&logo=Polestar)
...
- [form-generator](https://github.com/JakHuang/form-generator) - Element UI表单设计及代码生成器 ![](https://img.shields.io/github/stars/JakHuang/form-generator?style=social) ![](https://img.shields.io/github/last-commit/JakHuang/form-generator?style=flat&logo=Polestar)
...
- [react-window](https://github.com/bvaughn/react-window) - 用于高效渲染大型列表和表格数据的React组件 ![](https://img.shields.io/github/stars/bvaughn/react-window?style=social) ![](https://img.shields.io/github/last-commit/bvaughn/react-window?style=flat&logo=Polestar)
...
- [pure-admin-thin](https://github.com/pure-admin/pure-admin-thin) - vue-pure-admin官方精简版 ![](https://img.shields.io/github/stars/pure-admin/pure-admin-thin?style=social) ![](https://img.shields.io/github/last-commit/pure-admin/pure-admin-thin?style=flat&logo=Polestar)
...
- [vue2-manage](https://github.com/bailicangdu/vue2-manage) - 基于vue2 + element-ui的后台管理系统 ![](https://img.shields.io/github/stars/bailicangdu/vue2-manage?style=social) ![](https://img.shields.io/github/last-commit/bailicangdu/vue2-manage?style=flat&logo=Polestar)
...
- [RuoYi-Vue](https://github.com/yangzongzhuan/RuoYi-Vue) - (RuoYi)官方仓库 基于SpringBoot，Spring Security，JWT，Vue & Element 的前后端分离权限管理系统，同时提供了 Vue3 的版本 ![](https://img.shields.io/github/stars/yangzongzhuan/RuoYi-Vue?style=social) ![](https://img.shields.io/github/last-commit/yangzongzhuan/RuoYi-Vue?style=flat&logo=Polestar)
...
- [SpringBlade](https://github.com/chillzhuang/SpringBlade) - SpringBlade 是一个由商业级项目升级优化而来的SpringCloud分布式微服务架构、SpringBoot单体式微服务架构并存的综合型项目，采用Java17 API重构了业务代码，完全遵循阿里巴巴编码规范。采用Spring Boot 3.2 、Spring Cloud 2023 、Mybatis 等核心技术，同时提供基于React和Vue的两个前端框架用于快速搭建企业级的SaaS多租户微服务平台。 ![](https://img.shields.io/github/stars/chillzhuang/SpringBlade?style=social) ![](https://img.shields.io/github/last-commit/chillzhuang/SpringBlade?style=flat&logo=Polestar)
- [mall-swarm](https://github.com/macrozheng/mall-swarm) - mall-swarm是一套微服务商城系统，采用了 Spring Cloud Alibaba、Spring Boot 3.2、Sa-Token、MyBatis、Elasticsearch、Docker、Kubernetes等核心技术，同时提供了基于Vue的管理后台方便快速搭建系统。mall-swarm在电商业务的基础集成了注册中心、配置中心、监控中心、网关等系统功能。 ![](https://img.shields.io/github/stars/macrozheng/mall-swarm?style=social) ![](https://img.shields.io/github/last-commit/macrozheng/mall-swarm?style=flat&logo=Polestar)
- [go-admin](https://github.com/go-admin-team/go-admin) - 基于Gin + Vue + Element UI & Arco Design & Ant Design 的前后端分离权限管理系统脚手架（包含了：多租户的支持，基础用户管理功能，jwt鉴权，代码生成器，RBAC资源控制，表单构建，定时任务等）3分钟构建自己的中后台项目 ![](https://img.shields.io/github/stars/go-admin-team/go-admin?style=social) ![](https://img.shields.io/github/last-commit/go-admin-team/go-admin?style=flat&logo=Polestar)
- [newbee-mall](https://github.com/newbee-ltd/newbee-mall) - newbee-mall是一套电商系统，包括基础版本(Spring Boot+Thymeleaf)、前后端分离版本(Spring Boot+Vue 3+Element-Plus+Vue-Router 4+Pinia+Vant 4) 、秒杀版本、Go语言版本、微服务版本(Spring Cloud Alibaba+Nacos+Sentinel+Seata+Spring Cloud Gateway+OpenFeign+ELK)。 前台商城系统包含首页门户、商品分类、新品上线、首页轮播、商品推荐、商品搜索、商品展示、购物车、订单结算、订单流程、个人订单管理、会员中心、帮助中心等模块。 后台管理系统包含数据面板、轮播图管理、商品管理、订单管理、会员管理、分类管理、设置等模块 ![](https://img.shields.io/github/stars/newbee-ltd/newbee-mall?style=social) ![](https://img.shields.io/github/last-commit/newbee-ltd/newbee-mall?style=flat&logo=Polestar)
- [CRMEB](https://github.com/crmeb/CRMEB) - CRMEB开源商城系统（PHP版） ![](https://img.shields.io/github/stars/crmeb/CRMEB?style=social) ![](https://img.shields.io/github/last-commit/crmeb/CRMEB?style=flat&logo=Polestar)
