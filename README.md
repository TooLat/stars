## JS
- [lodash](https://github.com/lodash/lodash) ![](https://img.shields.io/github/stars/lodash/lodash?style=social) 
- [immutable-js](https://github.com/immutable-js/immutable-js) - Js的不可变持久数据集合，可提高效率和简单性 ![](https://img.shields.io/github/stars/immutable-js/immutable-js?style=social) 
- [immer](https://github.com/immerjs/immer) - 实现不可变对象 ![](https://img.shields.io/github/stars/immerjs/immer?style=social) 
- [core-js](https://github.com/zloirock/core-js) - 模块化标准库 ![](https://img.shields.io/github/stars/zloirock/core-js?style=social) 
- [page-lifecycle](https://github.com/GoogleChromeLabs/page-lifecycle) - 页面生命周期 ![](https://img.shields.io/github/stars/GoogleChromeLabs/page-lifecycle?style=social) 
- [async-validator](https://github.com/yiminghe/async-validator) - 表单验证 ![](https://img.shields.io/github/stars/yiminghe/async-validator?style=social) 

## TS
- [type-challenges](https://github.com/type-challenges/type-challenges) - TS挑战 ![](https://img.shields.io/github/stars/type-challenges/type-challenges?style=social) 
...
- [stylus](https://github.com/stylus/stylus) - 预处理 ![](https://img.shields.io/github/stars/stylus/stylus?style=social) 
- [normalize.css](https://github.com/necolas/normalize.css) - css 重置 ![](https://img.shields.io/github/stars/necolas/normalize.css?style=social) 
- [cssfx](https://github.com/jolaleye/cssfx) - 简单精美的CSS效果 ![](https://img.shields.io/github/stars/jolaleye/cssfx?style=social) 
- [aos](https://github.com/michalsnik/aos) - 过渡动效 ![](https://img.shields.io/github/stars/michalsnik/aos?style=social) 
...
## 构建
- [vite](https://github.com/vitejs/vite) ![](https://img.shields.io/github/stars/vitejs/vite?style=social) 
- [unplugin-auto-import](https://github.com/antfu/unplugin-auto-import) - 按需引入api ![](https://img.shields.io/github/stars/antfu/unplugin-auto-import?style=social) 
- [parcel](https://github.com/parcel-bundler/parcel) - 极速零配置Web应用打包工具 ![](https://img.shields.io/github/stars/parcel-bundler/parcel?style=social) 
- [rollup](https://github.com/rollup/rollup) - 打包 ![](https://img.shields.io/github/stars/rollup/rollup?style=social) 
...
- [ssr](https://github.com/zhangyuang/ssr) ![](https://img.shields.io/github/stars/zhangyuang/ssr?style=social) 

## 低代码
- [awesome-lowcode](https://github.com/taowen/awesome-lowcode) - 国内低代码平台 ![](https://img.shields.io/github/stars/taowen/awesome-lowcode?style=social) 
...
- [date-fns](https://github.com/date-fns/date-fns) - 日期库 ![](https://img.shields.io/github/stars/date-fns/date-fns?style=social) 
- [draggabilly](https://github.com/desandro/draggabilly) - 拖动 ![](https://img.shields.io/github/stars/desandro/draggabilly?style=social) 
- [Sortable](https://github.com/SortableJS/Sortable) - 拖动排序 ![](https://img.shields.io/github/stars/SortableJS/Sortable?style=social) 
- [store.js](https://github.com/marcuswestin/store.js) - 数据存储 ![](https://img.shields.io/github/stars/marcuswestin/store.js?style=social) 
- [pdf.js](https://github.com/mozilla/pdf.js) - PDF阅读器 ![](https://img.shields.io/github/stars/mozilla/pdf.js?style=social) 
- [nprogress](https://github.com/rstacruz/nprogress) - 进度条 ![](https://img.shields.io/github/stars/rstacruz/nprogress?style=social) 
- [img-2](https://github.com/RevillWeb/img-2) - 图像预缓存 ![](https://img.shields.io/github/stars/RevillWeb/img-2?style=social) 
...
- [browser](https://github.com/mumuy/browser) - 浏览器判断 ![](https://img.shields.io/github/stars/mumuy/browser?style=social) 
- [moveable](https://github.com/daybrush/moveable) - 拖动、调整大小等 ![](https://img.shields.io/github/stars/daybrush/moveable?style=social) 
- [mobile-detect.js](https://github.com/hgoebl/mobile-detect.js) - 移动设备检测 ![](https://img.shields.io/github/stars/hgoebl/mobile-detect.js?style=social) 
...
- [video.js](https://github.com/videojs/video.js) - HTML5 & Flash 视频播放器 ![](https://img.shields.io/github/stars/videojs/video.js?style=social) 
...
- [Leaflet.ChineseTmsProviders](https://github.com/htoooth/Leaflet.ChineseTmsProviders) - 加载互联网地图插件 ![](https://img.shields.io/github/stars/htoooth/Leaflet.ChineseTmsProviders?style=social) 
- [Leaflet.heat](https://github.com/Leaflet/Leaflet.heat) - 热力图 ![](https://img.shields.io/github/stars/Leaflet/Leaflet.heat?style=social) 
- [Leaflet.markercluster](https://github.com/Leaflet/Leaflet.markercluster) - 点聚合 ![](https://img.shields.io/github/stars/Leaflet/Leaflet.markercluster?style=social) 
...
- [particles.js](https://github.com/VincentGarreau/particles.js) - 粒子特效 ![](https://img.shields.io/github/stars/VincentGarreau/particles.js?style=social) 
...
- [vux](https://github.com/airyland/vux) - 移动UI组件 ![](https://img.shields.io/github/stars/airyland/vux?style=social) 
- [vue2-elm](https://github.com/bailicangdu/vue2-elm) - vue2实践 ![](https://img.shields.io/github/stars/bailicangdu/vue2-elm?style=social) 
- [vue-i18n](https://github.com/kazupon/vue-i18n) - 国际化插件 ![](https://img.shields.io/github/stars/kazupon/vue-i18n?style=social) 
- [vue-slicksort](https://github.com/Jexordexan/vue-slicksort) - 拖动排序 ![](https://img.shields.io/github/stars/Jexordexan/vue-slicksort?style=social) 
- [vue-particles](https://github.com/creotip/vue-particles) - 粒子背景 ![](https://img.shields.io/github/stars/creotip/vue-particles?style=social) 
- [Vue.Draggable](https://github.com/SortableJS/Vue.Draggable) - 拖放组件 ![](https://img.shields.io/github/stars/SortableJS/Vue.Draggable?style=social) 
- [vue-scroller](https://github.com/wangdahoo/vue-scroller) - Scroller 组件 ![](https://img.shields.io/github/stars/wangdahoo/vue-scroller?style=social) 
- [vue-cropperjs](https://github.com/Agontuk/vue-cropperjs) - 图像裁剪器 ![](https://img.shields.io/github/stars/Agontuk/vue-cropperjs?style=social) 
- [v-contextmenu](https://github.com/heynext/v-contextmenu) - 上下文菜单 ![](https://img.shields.io/github/stars/heynext/v-contextmenu?style=social) 
- [vue-fontawesome](https://github.com/FortAwesome/vue-fontawesome) - 图标字体 ![](https://img.shields.io/github/stars/FortAwesome/vue-fontawesome?style=social) 
- [vue-quill-editor](https://github.com/surmon-china/vue-quill-editor) - 富文本编辑器 ![](https://img.shields.io/github/stars/surmon-china/vue-quill-editor?style=social) 
- [vue-lazyload](https://github.com/hilongjw/vue-lazyload) - 延迟加载图像或组件 ![](https://img.shields.io/github/stars/hilongjw/vue-lazyload?style=social) 
- [vue-devtools](https://github.com/vuejs/devtools) - 浏览器devtools扩展 ![](https://img.shields.io/github/stars/vuejs/devtools?style=social) 
- [vue-drawer-layout](https://github.com/hjl19911127/vue-drawer-layout) - 抽屉组件 / 侧滑菜单 ![](https://img.shields.io/github/stars/hjl19911127/vue-drawer-layout?style=social) 
...
- [wxParse](https://github.com/icindy/wxParse)  - 富文本解析组件 ![](https://img.shields.io/github/stars/icindy/wxParse?style=social) 
...
- [vitest](https://github.com/vitest-dev/vitest) ![](https://img.shields.io/github/stars/vitest-dev/vitest?style=social) 
- [mocha](https://github.com/mochajs/mocha) ![](https://img.shields.io/github/stars/mochajs/mocha?style=social) 
...
- [husky](https://github.com/typicode/husky) - git 钩子 ![](https://img.shields.io/github/stars/typicode/husky?style=social) 
- [lint-staged](https://github.com/okonet/lint-staged) - 文件过滤 ![](https://img.shields.io/github/stars/okonet/lint-staged?style=social) 
- [nw.js](https://github.com/nwjs/nw.js) - 桌面应用 ![](https://img.shields.io/github/stars/nwjs/nw.js?style=social) 
- [electron](https://github.com/electron/electron) - 桌面应用 ![](https://img.shields.io/github/stars/electron/electron?style=social) 
- [electron-vue](https://github.com/SimulatedGREG/electron-vue) - Electron & Vue.js ![](https://img.shields.io/github/stars/SimulatedGREG/electron-vue?style=social) 
- [vue-cli-plugin-electron-builder](https://github.com/nklayman/vue-cli-plugin-electron-builder) - vue-cli3 ![](https://img.shields.io/github/stars/nklayman/vue-cli-plugin-electron-builder?style=social) 
- [hexo](https://github.com/hexojs/hexo) - 博客框架 ![](https://img.shields.io/github/stars/hexojs/hexo?style=social) 
- [hexo-theme-yilia](https://github.com/litten/hexo-theme-yilia) - hexo主题 ![](https://img.shields.io/github/stars/litten/hexo-theme-yilia?style=social) 
...
- [vivus](https://github.com/maxwellito/vivus) - SVG上制作绘图动画 ![](https://img.shields.io/github/stars/maxwellito/vivus?style=social) 
- [normalizr](https://github.com/paularmstrong/normalizr) - JSON数据范式化 ![](https://img.shields.io/github/stars/paularmstrong/normalizr?style=social) 
- [FiraCode](https://github.com/tonsky/FiraCode) - 免费的编程连字等宽字体 ![](https://img.shields.io/github/stars/tonsky/FiraCode?style=social) 
- [typescript-library-starter](https://github.com/alexjoverm/typescript-library-starter) - ts 脚手架 ![](https://img.shields.io/github/stars/alexjoverm/typescript-library-starter?style=social) 
- [Mock](https://github.com/nuysoft/Mock) - 生成随机数据，拦截 Ajax 请求 ![](https://img.shields.io/github/stars/nuysoft/Mock?style=social) 
- [hoppscotch](https://github.com/hoppscotch/hoppscotch) - 创建API访问，对标 Postman ![](https://img.shields.io/github/stars/hoppscotch/hoppscotch?style=social) 
- [easy-mock](https://github.com/easy-mock/easy-mock) - 可视化，并且能快速生成模拟数据的持久化服务 ![](https://img.shields.io/github/stars/easy-mock/easy-mock?style=social) 
...
## webpack
- [webpack](https://github.com/webpack/webpack) ![](https://img.shields.io/github/stars/webpack/webpack?style=social) 
- [dive-into-webpack](https://github.com/gwuhaolin/dive-into-webpack) - 深入浅出webpack ![](https://img.shields.io/github/stars/gwuhaolin/dive-into-webpack?style=social) 
- [happypack](https://github.com/amireh/happypack) ![](https://img.shields.io/github/stars/amireh/happypack?style=social) 
- [webpack-demos](https://github.com/ruanyf/webpack-demos) - demo ![](https://img.shields.io/github/stars/ruanyf/webpack-demos?style=social) 
- [clean-webpack-plugin](https://github.com/johnagan/clean-webpack-plugin) - 删除构建文件 ![](https://img.shields.io/github/stars/johnagan/clean-webpack-plugin?style=social) 
- [progress-bar-webpack-plugin](https://github.com/clessg/progress-bar-webpack-plugin) - 进度条 ![](https://img.shields.io/github/stars/clessg/progress-bar-webpack-plugin?style=social) 
- [webpack-parallel-uglify-plugin](https://github.com/gdborton/webpack-parallel-uglify-plugin) - js压缩 ![](https://img.shields.io/github/stars/gdborton/webpack-parallel-uglify-plugin?style=social) 
- [copy-webpack-plugin](https://github.com/webpack-contrib/copy-webpack-plugin) - 复制文件和目录 ![](https://img.shields.io/github/stars/webpack-contrib/copy-webpack-plugin?style=social) 
- [favicons-webpack-plugin](https://github.com/jantimon/favicons-webpack-plugin) - 生成 favicons ![](https://img.shields.io/github/stars/jantimon/favicons-webpack-plugin?style=social) 
- [html-webpack-plugin](https://github.com/jantimon/html-webpack-plugin) - 简化HTML文件的创建 ![](https://img.shields.io/github/stars/jantimon/html-webpack-plugin?style=social) 
- [optimize-css-assets-webpack-plugin](https://github.com/NMFR/optimize-css-assets-webpack-plugin) - 优化/最小化CSS ![](https://img.shields.io/github/stars/NMFR/optimize-css-assets-webpack-plugin?style=social) 
...
## nodejs
- [nodejs](https://github.com/nodejs/node) ![](https://img.shields.io/github/stars/nodejs/node?style=social) 
- [express](https://github.com/expressjs/express) - node 框架 ![](https://img.shields.io/github/stars/expressjs/express?style=social) 
- [nodebestpractices](https://github.com/goldbergyoni/nodebestpractices) - nodejs最佳实践 ![](https://img.shields.io/github/stars/goldbergyoni/nodebestpractices?style=social) 
- [passport](https://github.com/jaredhanson/passport) - 登录验证中间件 ![](https://img.shields.io/github/stars/jaredhanson/passport?style=social) 
- [shelljs](https://github.com/shelljs/shelljs) ![](https://img.shields.io/github/stars/shelljs/shelljs?style=social) 
- [node-fs-extra](https://github.com/jprichardson/node-fs-extra) - fs对象的额外方法，例如copy、remove、mkdirs ![](https://img.shields.io/github/stars/jprichardson/node-fs-extra?style=social) 
- [koa](https://github.com/koajs/koa) - Express的下一代基于Node.js的web框架 ![](https://img.shields.io/github/stars/koajs/koa?style=social) 
- [koa2-note](https://github.com/chenshenhai/koa2-note) - koa2学习笔记 ![](https://img.shields.io/github/stars/chenshenhai/koa2-note?style=social) 
...
- [grapesjs](https://github.com/artf/grapesjs) - web模板编辑器 ![](https://img.shields.io/github/stars/artf/grapesjs?style=social) 

## 终端
- [ora](https://github.com/sindresorhus/ora) - 终端旋转器 ![](https://img.shields.io/github/stars/sindresorhus/ora?style=social) 
- [chalk](https://github.com/chalk/chalk) - 字符串样式 ![](https://img.shields.io/github/stars/chalk/chalk?style=social) 

## You-Dont-Need
- [You-Dont-Need-JavaScript](https://github.com/you-dont-need/You-Dont-Need-JavaScript) - 一些效果的CSS实现 ![](https://img.shields.io/github/stars/you-dont-need/You-Dont-Need-JavaScript?style=social) 
- [You-Dont-Need-GUI](https://github.com/you-dont-need/You-Dont-Need-GUI) - 一些命令行操作 ![](https://img.shields.io/github/stars/you-dont-need/You-Dont-Need-GUI?style=social) 
- [You-Dont-Need-jQuery](https://github.com/camsong/You-Dont-Need-jQuery) ![](https://img.shields.io/github/stars/camsong/You-Dont-Need-jQuery?style=social) 
- [You-Dont-Need-Lodash-Underscore](https://github.com/you-dont-need/You-Dont-Need-Lodash-Underscore) ![](https://img.shields.io/github/stars/you-dont-need/You-Dont-Need-Lodash-Underscore?style=social) 
- [You-Dont-Need-Momentjs](https://github.com/you-dont-need/You-Dont-Need-Momentjs) ![](https://img.shields.io/github/stars/you-dont-need/You-Dont-Need-Momentjs?style=social) 
- [youmightnotneedjquery](https://github.com/HubSpot/youmightnotneedjquery) - jq原生实现 ![](https://img.shields.io/github/stars/HubSpot/youmightnotneedjquery?style=social) 

## 导航
- [GitHub-Chinese-Top-Charts](https://github.com/GrowingGit/GitHub-Chinese-Top-Charts) - GitHub中文排行榜 ![](https://img.shields.io/github/stars/GrowingGit/GitHub-Chinese-Top-Charts?style=social) 

## Awesome
- [awesome](https://github.com/sindresorhus/awesome) ![](https://img.shields.io/github/stars/sindresorhus/awesome?style=social) 
- [awesome-vue](https://github.com/vuejs/awesome-vue) ![](https://img.shields.io/github/stars/vuejs/awesome-vue?style=social) 
- [awesome-react](https://github.com/enaqx/awesome-react) ![](https://img.shields.io/github/stars/enaqx/awesome-react?style=social) 
- [awesome-react-native](https://github.com/jondot/awesome-react-native) ![](https://img.shields.io/github/stars/jondot/awesome-react-native?style=social) 
- [awesome-mac](https://github.com/jaywcjlove/awesome-mac) ![](https://img.shields.io/github/stars/jaywcjlove/awesome-mac?style=social) 
- [awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) ![](https://img.shields.io/github/stars/sindresorhus/awesome-nodejs?style=social) 
- [awesome-javascript](https://github.com/sorrycc/awesome-javascript) ![](https://img.shields.io/github/stars/sorrycc/awesome-javascript?style=social) 
- [awesome-vscode](https://github.com/viatsko/awesome-vscode) ![](https://img.shields.io/github/stars/viatsko/awesome-vscode?style=social) 
- [awesome-wechat-weapp](https://github.com/justjavac/awesome-wechat-weapp) - 小程序 ![](https://img.shields.io/github/stars/justjavac/awesome-wechat-weapp?style=social) 
- [awesome-flutter](https://github.com/Solido/awesome-flutter) ![](https://img.shields.io/github/stars/Solido/awesome-flutter?style=social) 
...
- [standard](https://github.com/standard/standard) - JavaScript 代码规范，自带 linter & 代码自动修正 ![](https://img.shields.io/github/stars/standard/standard?style=social) 
- [airbnb/javascript](https://github.com/airbnb/javascript) - JavaScript 样式指南 ![](https://img.shields.io/github/stars/airbnb/javascript?style=social) 
- [TheAlgorithms/JavaScript](https://github.com/TheAlgorithms/JavaScript) - JavaScript 中为初学者实现的算法和数据结构 ![](https://img.shields.io/github/stars/TheAlgorithms/JavaScript?style=social) 

## 技术知识
- [You-Dont-Know-JS](https://github.com/getify/You-Dont-Know-JS) ![](https://img.shields.io/github/stars/getify/You-Dont-Know-JS?style=social) 
- [30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code) ![](https://img.shields.io/github/stars/30-seconds/30-seconds-of-code?style=social) 
- [fe-interview](https://github.com/haizlin/fe-interview) - 面试题 ![](https://img.shields.io/github/stars/haizlin/fe-interview?style=social) 
- [FE-Interview](https://github.com/lgwebdream/FE-Interview) - 前端面试 ![](https://img.shields.io/github/stars/lgwebdream/FE-Interview?style=social) 
- [leetcode](https://github.com/azl397985856/leetcode) - leetcode题解 ![](https://img.shields.io/github/stars/azl397985856/leetcode?style=social) 
- [git-recipes](https://github.com/geeeeeeeeek/git-recipes) - git中文教程 ![](https://img.shields.io/github/stars/geeeeeeeeek/git-recipes?style=social) 
- [javascript-tutorial](https://github.com/wangdoc/javascript-tutorial) - js 手册 ![](https://img.shields.io/github/stars/wangdoc/javascript-tutorial?style=social) 
- [learnVue](https://github.com/answershuto/learnVue) - Vue.js 源码解析 ![](https://img.shields.io/github/stars/answershuto/learnVue?style=social) 
- [gold-miner](https://github.com/xitu/gold-miner) - 掘金翻译计划 ![](https://img.shields.io/github/stars/xitu/gold-miner?style=social) 
- [jstraining](https://github.com/ruanyf/jstraining) - 全栈工程师培训材料 ![](https://img.shields.io/github/stars/ruanyf/jstraining?style=social) 
- [es6tutorial](https://github.com/ruanyf/es6tutorial) - ECMAScript 6 入门 ![](https://img.shields.io/github/stars/ruanyf/es6tutorial?style=social) 
- [front-end-interview-handbook](https://github.com/yangshun/front-end-interview-handbook) - 前端面试手册 ![](https://img.shields.io/github/stars/yangshun/front-end-interview-handbook?style=social) 
- [Daily-Interview-Question](https://github.com/Advanced-Frontend/Daily-Interview-Question) - 每天一道前端面试题 ![](https://img.shields.io/github/stars/Advanced-Frontend/Daily-Interview-Question?style=social) 
- [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) - JavaScript 算法与数据结构 ![](https://img.shields.io/github/stars/trekhleb/javascript-algorithms?style=social) 
- [33-js-concepts](https://github.com/stephentian/33-js-concepts) - JavaScript开发者应懂的33个概念 ![](https://img.shields.io/github/stars/stephentian/33-js-concepts?style=social) 
- [architecture.of.internet-product](https://github.com/davideuler/architecture.of.internet-product) - 互联网公司技术架构 ![](https://img.shields.io/github/stars/davideuler/architecture.of.internet-product?style=social) 
- [webpack-and-spa-guide](https://github.com/wallstreetcn/webpack-and-spa-guide) - Webpack 4 和单页应用入门 ![](https://img.shields.io/github/stars/wallstreetcn/webpack-and-spa-guide?style=social) 
- [jawil/blog](https://github.com/jawil/blog) - 讲解 ![](https://img.shields.io/github/stars/jawil/blog?style=social) 
- [markyun/My-blog](https://github.com/markyun/My-blog) - 面试题 ![](https://img.shields.io/github/stars/markyun/My-blog?style=social) 
- [mqyqingfeng/Blog](https://github.com/mqyqingfeng/Blog) - JS深入系列 ![](https://img.shields.io/github/stars/mqyqingfeng/Blog?style=social) 
- [CS-Notes](https://github.com/CyC2018/CS-Notes) - 技术面试必备基础知识、Leetcode、计算机操作系统、计算机网络、系统设计 ![](https://img.shields.io/github/stars/CyC2018/CS-Notes?style=social) 
- [wtfjs](https://github.com/denysdovhan/wtfjs) - 一个有趣和棘手的 JavaScript 示例列表 ![](https://img.shields.io/github/stars/denysdovhan/wtfjs?style=social) 
- [hello-algorithm](https://github.com/geekxh/hello-algorithm) - 算法 ![](https://img.shields.io/github/stars/geekxh/hello-algorithm?style=social) 
- [secguide](https://github.com/Tencent/secguide) - 代码安全指南 ![](https://img.shields.io/github/stars/Tencent/secguide?style=social) 
